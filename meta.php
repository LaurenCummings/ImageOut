        ...
        if ( $bundled_items ) {
            ...
            foreach ( $bundled_items as $bundled_item ) {
                ...
                <div class="film">
                        ...
                        <?php 
                        	if ($bundled_post->_trailer !== ""){
                        		echo '<iframe src="';
                        		echo $bundled_post->_trailer; 
...
<!-- //END OF Film Fields -->
	...
	<?php 
		if (get_post_meta( get_the_ID(), '_community_partner', true ) !== "") {

			echo 	'<div class="community_partner">
						<h2>COMMUNITY PARTNER</h2>';
							echo get_post_meta( get_the_ID(), '_community_partner', true );
			echo	'</div>';
		}
	?>
