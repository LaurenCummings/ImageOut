...
if( !class_exists( 'YITH_WCPB_Admin' ) ) {
    ...
    class YITH_WCPB_Admin {
        ...
        public function product_type_selector( $types ){
            $types[ 'yith_bundle' ] = _x( 'Program', 'Admin: type of product', 'yith-wcpb' );
            return $types;
        }
...
<!--             <table>
        ...
        public function woocommerce_product_data_tabs( $product_data_tabs ){
            $product_data_tabs['yith_bundled_options'] = array(
                            'label'  => __( 'Select Films', 'yith-wcpb' ),
...
<!--                         <p class="toolbar">
                        ...
                        <p class="yith-wcpb-bundled-prod-toolbar toolbar">
                            <span class="yith-wcpb-bundled-prod-toolbar-wrapper">
                                <span class="yith-wcpb-bundled-prod-selector">
                                    <input type="hidden" class="wc-product-search" style="width: 250px;" id="yith-wcpb-bundled-product" name="yith_wcpb_bundled_product" data-placeholder="<?php _e( 'Search for a film&hellip;', 'woocommerce' ); ?>" data-action="woocommerce_json_search_products" data-multiple="false" data-selected="" value="" />
                                </span>
        ...
        public function admin_enqueue_scripts() {
            ...
            wp_enqueue_style( 'jquery-ui-style-css', YITH_WCPB_ASSETS_URL . '/css/jquery-ui.css' );
